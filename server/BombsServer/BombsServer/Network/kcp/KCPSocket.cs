...
//                Log.Error("Close() " + e.Message + e.StackTrace);
//            }
...
//            catch (Exception e)
//            {
//                Log.Error("Thread_Recv() " + e.Message + "\n" + e.StackTrace);
//                Thread.Sleep(10);
//            }
//        }
//        Log.Info("Thread_Recv() End!");
//    }
...
//        m_Kcp = new KCP(key,null);
//        m_Kcp.SetOutput(HandleKcpSend);
...
//    //---------------------------------------------
//    private void HandleKcpSend(byte[] buff, int size, object ud)
//    {
//        if (m_Socket != null)
//        {
...
//        return m_Kcp.Send(buff,0, size) >= 0;
//    }
...
//            int ret = m_Kcp.Input(recvBufferRaw,0, recvBufferRaw.Length);
...
//                if (m_Kcp.Recv(recvBuffer,0, size) > 0)
//                {
//                    if (m_Listener != null)
//                    {
