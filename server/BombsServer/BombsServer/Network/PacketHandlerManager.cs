...
using System.Threading.Tasks;
    ...
    {
        public delegate void PacketHandlerFunc(Client Client,  byte[] datas, ushort start_index, ushort length);
        ...
        public virtual void Handle(Client Client,  byte command, byte[] datas, ushort start_index,ushort length)
        {
            ...
            try
            {
                handler(Client,datas, start_index, length);
            }
